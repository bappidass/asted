        ...
        <div className="bg-brand-light-gray border-2 border-primary rounded-lg overflow-hidden">
          <div className="grid lg:grid-cols-2">
            ...
            <div className="bg-primary text-primary-foreground p-12 space-y-8">
              <div>
                <div className="flex items-center space-x-2 mb-6">
                  <div className="bg-accent w-8 h-8 rounded flex items-center justify-center">
                    <span className="text-primary font-oswald font-bold text-lg">A</span>
                  </div>
                  <div>
                    <h3 className="font-oswald font-bold text-xl">asted</h3>
                    <p className="text-xs opacity-90 tracking-wider">WE ARE HERE</p>
                  </div>
                </div>

                <h2 className="font-oswald font-bold text-section-header mb-6">
            ...
            <div className="bg-background p-12 space-y-8">
              <h3 className="font-oswald font-bold text-card-header text-primary text-center">
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-6">
                    {predefinedAmounts.map((amount) => (
                      <button
                        ...
                        className={`py-3 px-4 font-oswald font-semibold border-2 transition-all ${
