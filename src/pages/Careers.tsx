    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[400px] bg-primary overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 h-full flex flex-col justify-center items-center text-center">
          ...
          <h1 className="font-oswald font-bold text-6xl md:text-7xl text-brand-white mb-6">
            CAREERS
          </h1>
      ...
      <section className="py-20 bg-brand-light-gray">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {jobs.map((job) => (
              <Card key={job.id} className="bg-brand-white border-0 shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge 
                      className={`font-work-sans text-sm px-4 py-2 ${
                        job.status === 'open' 
